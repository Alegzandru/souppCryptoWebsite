export const globalContent = [
    {
        ...
        testimonialsContent:
        {
            heading: "Узнайте что говорят о нас клиенты"
        },
        contactsContent:
        {
            heading: "Контакты",
            heading1: "С нами легко связатся!",
            heading2: "Обратная связь",
            button: "Отправить",
            input1: "Ваше имя",
            input2: "Ваша электронная почта",
            input3: "Ваше сообщение",
            emailSent: "Ваше сообщение отправлено!"
        },
        navbarContent:
        {
            link1 : "Главная",
        ...
        layout: {
            titleMain : "Главная страница | SOUPP CRYPTO CAPITAL",
            titleDisclaimer : "Дисклеймер | SOUPP CRYPTO CAPITAL",
            meta : "SOUPP CRYPTO CAPITAL, именуемое далее как SPCC - это сообщество людей, мотивированных и зацикленных на свободе: свободе дела и слова, свободе действия и передвижения в рамках финансовой свободы. Это люди, чей упор сделан на финансовой грамотности и независимости от предрассудков, обстоятельств, посредством работы на перспективном, высоковолатильном рынке."
        }
    },
    {
        ...
        testimonialsContent:
        {
            heading: "Find out what our clients say about us"
        },
        contactsContent:
        {
            heading: "Contacts",
            ...
            input2: "Your email",
            input3: "Your message",
            emailSent: "Your message was sent!"
        },
        navbarContent:
        {
            link1 : "Main Page",
        ...
        disclaimer : {
            ...
            textShort : "The Content is for informational purposes only, you should not construe any such information or other material as legal, tax, investment, financial, or other advice. Nothing contained on our Site constitutes a solicitation, recommendation, endorsement, or offer by SPCC or any third party service provider to buy or sell any securities or other financial instruments in this or in in any other jurisdiction in which such solicitation or offer would be unlawful under the securities laws of such jurisdiction. SPCC, its affiliates or any third party service provider are not responsible for damages arising from any decision you make based on information or other Content available on the Site.",
        ...
        layout: {
            titleMain : "Main Page | SOUPP CRYPTO CAPITAL",
            titleDisclaimer : "Disclaimer | SOUPP CRYPTO CAPITAL",
            meta : "SOUPP CRYPTO CAPITAL, hereinafter referred to as SPCC , is a community of people who are motivated and fixated on freedom: freedom of business and speech, freedom of action and movement within the framework of financial freedom. These are people whose focus is on financial literacy and independence from prejudices, circumstances, through working in a promising, highly volatile market."
        }
    }
]